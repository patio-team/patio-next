      ...
      <div className="flex-1 flex flex-col justify-center items-center px-6 py-8 lg:px-8 lg:py-12 xl:px-16 relative z-10">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-6">
            <span className="font-lato text-base text-[#34314C]">or</span>
          </div>

          {/* Email Input */}
          <div className="mb-6">
            <label className="block font-lato text-base text-[#34314C] mb-3">
              Email adress
            </label>
            <input
              type="email"
              ...
              className="w-full h-[42px] px-4 border border-[#DBDAE7] rounded-lg bg-white font-lato text-base placeholder-[#948FB7] focus:outline-none focus:border-[#3FA2F7] transition-colors"
            />
          </div>
          ...
          <div className="mb-6 relative">
            ...
            <div className="relative">
              <input
                ...
                placeholder="********"
                className="w-full h-[42px] px-4 pr-12 border border-[#DBDAE7] rounded-lg bg-white font-lato text-base placeholder-[#948FB7] focus:outline-none focus:border-[#3FA2F7] transition-colors"
              />
              <button
                type="button"
            ...
            <div className="flex justify-end mt-2">
              <a
                href="#"
                className="font-lato text-base text-[#3FA2F7] hover:underline"
              >
                Forgot password?
              </a>
            </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <button
              ...
              className="w-full sm:w-[240px] h-[60px] bg-[#C3C1D7] disabled:bg-[#C3C1D7] enabled:bg-[#3FA2F7] enabled:hover:bg-[#2991e6] rounded-tl-[20px] rounded-br-[20px] font-lato text-base font-bold text-white transition-colors"
            >
              Sign in
            </button>
          </div>
          ...
          {/* Sign Up Link */}
          <p className="font-lato text-base text-[#34314C] text-center">
            Not a member?{" "}
            <a href="#" className="text-[#3FA2F7] hover:underline">
              Sign up
            </a>
          </p>
        </div>
